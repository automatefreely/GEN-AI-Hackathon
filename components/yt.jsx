...
import { Brain, Send, PlayCircle, PauseCircle, User, Mic, Volume2, VolumeX } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="flex-1 py-12 px-8">
        <div className="container mx-auto grid gap-6 lg:grid-cols-2">
          ...
          <Card className="w-full overflow-hidden">
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-4">Video Learning</h2>
              {videoUrl ? (
                <div className="relative aspect-video mb-4">
                  <iframe
                    ref={videoRef}
              ...
              <Button onClick={triggerQuestion}>Test Your Knowledge</Button>
            </CardContent>
          </Card>
        </div>
      </main>
